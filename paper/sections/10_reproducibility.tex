...
in the source map and claim ledger shipped with the public companion
repository.
...
path.  The public repository has also passed an external mathematical and
packaging red-team review, whose actionable findings are incorporated in the
current sources.  Repository availability is nevertheless distinct from
journal peer review or archival publication: a public exact certificate is
not by itself independent acceptance of the article.
